...
from app.models.product_tag_model import ProductTag, ProductTagCreate, ProductTagPublic, ProductTagUpdate, ProductTagsPublic, ProductTagPublicDetail
...
@router.get("/{id}", response_model=ProductTagPublicDetail)
...
def create_product_tag(
    *, session: SessionDep, current_user: CurrentUser, product_tag_in: ProductTagCreate
    ...
    # create product tag and add it to product
    
    product_tag = product_tag_crud.create_product_tag(session, product_tag_in, current_user.id)
    
    # product = product_crud.get(session, product_tag_in.product_id)
    ...
    # product_tag_link = ProductTagLink(
